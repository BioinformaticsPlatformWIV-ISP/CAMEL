...
class HitFiltering(Tool):
    """
    Class that filters blast hits and reports the best hits. Perfect hits are always reported. The best hits is selected
    from groups of overlapping hits.

    Input:
        TSV: Tabular file generated by blast using the TSV: Tabular file generated by Blastn with
            '7 pident sseqid sseq slen qseqid qstart qend' output format.
