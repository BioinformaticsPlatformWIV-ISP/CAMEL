...
class VelvetOptimiser(Velvet):
    ...
    def __set_output(self):
        ...
        self._tool_outputs['FASTA_Contig'] = [ToolIOFile(os.path.join(self.output_dir, VelvetOptimiser.OUTPUT_FASTA))]
    ...
    def __set_inform(self):
        ...
        self.informs.update(
            VelvetgOutputAnalyzer.analyze_log_file(os.path.join(self.output_dir, VelvetOptimiser.LOG_FILE))
        )

        log_file_path = os.path.join(self.output_dir, self._parameters[
        ...
        self.informs.update(
            VelvetgOutputAnalyzer.analyze_stats_file(
                self._informs, os.path.join(self.output_dir, VelvetOptimiser.STATS_FILE))
        )
