...
class BasePipeline(object, metaclass=abc.ABCMeta):
    ...
    def add_common_arguments(argument_parser: argparse.ArgumentParser) -> None:
        ...
        """
        # Input
        argument_parser.add_argument('--fasta', type=absolute_path_by_pathlib,
                                     help="Input FASTA file")
        argument_parser.add_argument('--vcf-unfiltered', type=absolute_path_by_pathlib,
                                     help="Input VCF file (only in combination with FASTA file)")
        ...
        argument_parser.add_argument('--fastq-pe', nargs=2, type=absolute_path_by_pathlib,
                                     help="Input PE FASTQ files")
        argument_parser.add_argument(
            '--fastq-pe-names', nargs=2, help="Input PE FASTQ filenames (for Galaxy)")
        argument_parser.add_argument('--fastq-se', type=absolute_path_by_pathlib,
                                     help="Input SE FASTQ file")
        argument_parser.add_argument(
