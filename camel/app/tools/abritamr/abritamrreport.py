...
class AbriTAMRReport(Tool):
    ...
    def __set_output(self) -> None:
        """
        Sets the name of the output files. Two other files are generated by the tool but I don't track them here
        as they don't have any interest for the results.
        :return: None
        """
    ...
    def __build_command(self) -> None:
        ...
        self._command.command = ' '.join([
            self._tool_command, '--matches',
            str(self._tool_inputs['TXT_MATCHES'][0]), '--partials', str(self._tool_inputs['TXT_PARTIALS'][0]),
            '--qc', str(self._tool_inputs['TXT_MDU_QC'][0]), '--r report_abritamr', f'--sop {sop}'])
