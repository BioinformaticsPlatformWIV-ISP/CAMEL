...
class GATK4VariantRecalibrator(GATK4):
    ...
    'TXT_plots':                Optional. ToolIOFile object. The output rscript file generated by the VQSR to aid in
    ...
    def _set_output(self) -> None:
        """
        Set output of GATK VariantRecalibrator tool. Adds tranches file to parent class output. If the r-script parameter
        is defined, the plot files are added to the output, too
        :return:
        """
        super()._set_output()
        ...
        if 'rscript_file' in self._parameters:
            self._tool_outputs['TXT_plots'] = [
                ToolIOFile(self.folder / self._parameters['rscript_file'].value)
            ]
