...
class SRST2AlleleDetector(Tool):
    ...
    @staticmethod
    def __get_tabular_output_file(output_folder: str) -> str:
        """
    ...
    def __extract_hit(self, locus_name: str, srst2_output: str) -> SequenceTypingSRST2Hit:
        """
