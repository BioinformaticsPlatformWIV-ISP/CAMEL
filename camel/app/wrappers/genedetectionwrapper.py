...
class GeneDetectionWrapper:
    ...
    def __run(self, config_data: dict[str, Any], threads: int) -> None:
        """
    ...
    def run_blast(self, fasta_path: Path, sample_name: str, db_data: dict[str, Any], threads: int = 8) -> None:
        """
        ...
        self.__run(config_data, threads)

    def run_kma(self, fastq_input: FastqInput, sample_name: str, db_data: dict[str, Any],
                         threads: int = 8) -> None:
        """
