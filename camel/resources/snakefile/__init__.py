...
SNAKEFILE_READ_TRIMMING_IONTORRENT = os.path.join(_current_dir, 'read_trimming_iontorrent.smk')
...
SNAKEFILE_SEQUENCE_TYPING_KMA = os.path.join(_current_dir, 'sequence_typing_kma.smk')
