...
class MainAMRFinder(object):
    ...
    def run(self) -> None:
        ...
        report = mainscriptutils.init_report(
            self._args.output_html, self._args.output_dir, 'NCBI AMRFinder report', 'NCBI AMRFinder')
        additional_info = [
        ...
        report.add_html_object(SnakePipelineUtils.create_commands_section([amrfinder.informs], self._args.working_dir))
