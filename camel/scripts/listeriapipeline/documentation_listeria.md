...
|----------------------------------------|-----------------------|--------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Kraken: contaminants                   | 1.00% / 5.00% (ONT)   | 5.00% / 10% (ONT)  | Percentage of reads / contigs assigned to species other than *L. monocytogenes*                                                                                                                                                 |
...
Alternative detection using `kma 1.4.12a` or `SRST2 0.2.0` is available by changing the `--gene-detection-method` parameter.
