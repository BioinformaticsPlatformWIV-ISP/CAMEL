...
class MainShigellaPipeline(BasePipe):
    """
...
@click.command(name='shigella_pipeline', short_help='Pipeline for the complete characterization of Shigella isolates')
...
def main(**kwargs) -> None:
    """
    Pipeline for the complete characterization of Shigella isolates.
    """
