...
from camel.resources import YAML_READ_MAPPING_BOWTIE2, YAML_SAMTOOLS_VARIANT_CALLING
from camel.scripts.snpphylogeny.samtools.vcffiltering import VcfFiltering
