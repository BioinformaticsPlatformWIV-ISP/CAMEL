...
|----------------------------------------|-----------------------|--------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Kraken: contaminants                   | 1.00% / 5.00% (ONT)   | 5.00% / 10% (ONT)  | Percentage of reads / contigs assigned to species other than *Escherichia coli*                                                                                                                                                 |
...
changing the `--gene-detection-method` parameter.
