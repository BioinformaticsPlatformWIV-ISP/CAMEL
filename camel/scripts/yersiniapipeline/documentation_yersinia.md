...
|----------------------------------------|-----------------------|--------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Kraken: contaminants                   | 1.00% / 5.00% (ONT)   | 5.00% / 10% (ONT)  | Percentage of reads or contigs assigned to species other than *Y. enterocolitica* or *Y. pseudotuberculosis*                                                                                                                    |
...
Alternative detection using `kma 1.4.12a` is available by changing the `--gene-detection-method` parameter.
