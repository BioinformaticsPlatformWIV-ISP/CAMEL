...
class TestAmpliGone(CamelTestSuite):
    ...
    FILE_FASTA_REF = ToolIOFile(Path(
        Camel.get_instance().config['db_root'], 'pipelines', 'viral_consensus', 'ref_genomes',
        'sars_cov_2-Wuhan-Hu-1.fasta'))
    ...
    def test_ampligone_ont(self) -> None:
        ...
        :return: None
        """
        ampligone = AmpliGone(self.camel)
    ...
    def test_ampligone_reporter_ont(self) -> None:
        ...
        # Run reporter
        reporter = AmpliGoneReporter(self.camel)
        ...
        SnakemakeUtils.dump_object(reporter.tool_outputs['HTML'], self.running_dir / 'html.io')
    ...
    def test_ampligone_fasta2bed(self) -> None:
        ...
        :return: None
        """
        ampligone_fasta2bed = AmpliGoneFasta2Bed(self.camel)
    ...
    def test_ampligone_fasta2bed_reporter(self) -> None:
        ...
        # Run reporter
        reporter = AmpliGoneFasta2BedReporter(self.camel)
