...
class TestAMRScreen(CamelTestSuite):
    ...
    path_db = Path(Camel.get_instance().config['db_root'], 'pipelines', 'mycobacterium', 'amr', 'who_2023.6')
    ...
    def test_amrscreen(self) -> None:
        ...
        bcf_filter = BcftoolsFilter(self.camel)
        ...
        # Run the tool
        amr_screen = AMRScreen(self.camel)
