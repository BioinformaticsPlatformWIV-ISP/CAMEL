...
from camel.scripts.neisseriapipeline.mainneisseriapipeline import main
...
class TestNeisseriaPipeline(CamelTestSuite):
    ...
    def test_illumina_blast(self) -> None:
        ...
        result = cliutils.invoke(
            ...
            [
                ...
                '--analyses',
                ','.join(a for a in CUSTOM_ANALYSES if 'cgmlst' not in a),
            ],
        )
    ...
    def test_fasta_blast(self) -> None:
        ...
        result = cliutils.invoke(
            ...
            [
                '--fasta',
                str(TestNeisseriaPipeline.input_fasta),
                '--input-type',
                'fasta',
                '--output-html',
                str(path_report_out),
    ...
    def test_ont_blast(self) -> None:
        ...
        result = cliutils.invoke(
            ...
            [
                '--fastq-se',
                str(TestNeisseriaPipeline.input_fastq_se),
                '--input-type',
                'ont',
                '--output-html',
                str(path_report_out),
