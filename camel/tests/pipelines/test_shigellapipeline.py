...
class TestShigellaPipeline(unittest.TestCase):
    """
    ...
    input_fastq_pe = [
        test_file_dir / 'pipelines' / 'Shigella-S17BD07654_1.fastq.gz',
        test_file_dir / 'pipelines' / 'Shigella-S17BD07654_2.fastq.gz'
    ]
    ...
    def setUp(self):
        ...
        :return: None
        """
        self.running_dir = Path(tempfile.mkdtemp(None, 'camel_', TestShigellaPipeline.camel.config['temp_dir']))
    ...
    @longRunningTest()
    def test_shigella_pipeline(self) -> None:
        """
