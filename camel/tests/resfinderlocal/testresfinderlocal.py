...
class TestResFinderLocal(unittest.TestCase):
    ...
    #     output_file_report = os.path.join(self.running_dir, 'report', 'report.html')
    #     args = self.__get_basic_arguments(output_file_report, 'blast')
    #     args.fasta = TestResFinderLocal.input_fasta_galaxy.path
    #     args.fasta_name = TestResFinderLocal.input_fasta.basename
    ...
    #     output_file_report = os.path.join(self.running_dir, 'report', 'report.html')
    #     args = self.__get_basic_arguments(output_file_report, 'blast')
    #     args.fastq_pe = [f.path for f in TestResFinderLocal.input_reads_raw_galaxy]
    #     args.fastq_pe_names = [f.basename for f in TestResFinderLocal.input_reads_raw]
    #     main = MainGeneDetection(args)
    #     main.run()
    #     self.assertGreater(os.path.getsize(output_file_report), 0)
    #
    ...
    #     args.fastq_pe = [f.path for f in TestResFinderLocal.input_reads_raw]
    #     args.fastq_pe_names = [os.path.basename(p.path) for p in TestResFinderLocal.input_reads_raw]
    #     main = MainGeneDetection(args)
    #     main.run()
    #     self.assertGreater(os.path.getsize(output_file_report), 0)
    #
    ...
    #     output_file_report = os.path.join(self.running_dir, 'report', 'report.html')
    #     args = self.__get_basic_arguments(output_file_report, 'srst2')
    #     args.fastq_pe = [f.path for f in TestResFinderLocal.input_reads_no_hit]
    #     args.fastq_pe_names = [os.path.basename(p.path) for p in TestResFinderLocal.input_reads_no_hit]
    #     main = MainGeneDetection(args)
    #     main.run()
    #     self.assertGreater(os.path.getsize(output_file_report), 0)
    #
