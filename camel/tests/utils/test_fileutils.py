...
class TestFileUtils(CamelTestSuite):
    ...
    def test_hash_file(self) -> None:
        ...
        :return: None
        """
        self.assertEqual('258cf917517a15d335c42e9da9efdd6f157c88a22ab4a9aa94743dafe3c82fc1', FileUtils.hash_file(TestFileUtils.test_file_dir / 'fq-fwd.fq'))
    ...
    def test_get_all_files(self) -> None:
        ...
        :return: None
        """
        self.assertCountEqual(FileUtils.get_all_files(TestFileUtils.test_file_dir / 'hash_test'), [Path('/testdata/camel/components/hash_test/fq-fwd.fq'),
    ...
    def test_hash_directory(self) -> None:
        ...
        :return: None
        """
        self.assertEqual('e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855', FileUtils.hash_directory(TestFileUtils.test_file_dir / 'fq-fwd.fq'))
    ...
    def test_hash_value(self) -> None:
        ...
        :return: None
        """
        self.assertEqual('332f61e385645bc5ad755f2ff6ccf8c4693f569a79f33427065731e9ff41b812', FileUtils.hash_value('this_value_will_be_hashed'))
    ...
    def test_concatenate_files(self) -> None:
        ...
        :return: None
        """
        FileUtils.concatenate_files(self.running_dir / 'concat.fq', [TestFileUtils.test_file_dir / 'fq-fwd.fq',
                                                                     TestFileUtils.test_file_dir / 'fq-rev.fq'])
        self.assertTrue(filecmp.cmp(TestFileUtils.test_file_dir / 'fq-fwd-rev-concatenated.fq', self.running_dir / 'concat.fq', shallow=False))
    ...
    def test_concatenate_gzipped_files(self) -> None:
        ...
        :return: None
        """
        FileUtils.concatenate_files(self.running_dir / 'concat.fq.gz', [TestFileUtils.test_file_dir / 'fq-fwd.fq.gz',
