...
WORKFLOW_CONTAMINATION_CHECK = os.path.join(__CURRENT_DIR, 'contamination_check.snakefile')
...
WORKFLOW_QUALITY_CHECKS = os.path.join(__CURRENT_DIR, 'quality_checks.snakefile')
