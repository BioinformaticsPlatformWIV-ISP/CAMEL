...
rule FastQC_additional_checks:
    ...
    run:
        ...
        fastqc_checks.update_parameters(gc_content_reference=39, per_base_sequence_content_skipped_end='0.5%', n_fraction_threshold_fail=0.05, n_fraction_threshold_warn=0.01)
        step.run_step()
