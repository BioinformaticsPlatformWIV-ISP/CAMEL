...
from scripts.vtecpipeline import SNAKEFILE_VTEC_MAIN

"""
This test script can be used to run the assembly component of the VTEC pipeline. This will include the read trimming
step.
...
def _parse_arguments():
    ...
    argument_parser.add_argument("--fast", action='store_true', help='Speeds up the assembly using loose parameters')
...
if __name__ == '__main__':
    ...
    with open(config_path, 'w') as handle:
        ...
        yaml.dump({'assembly_fast': args.fast}, handle, default_flow_style=False)
